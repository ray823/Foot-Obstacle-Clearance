...
def main():
    ...
    #保存模型和權重
    saved = load_model('./LSTM model performance/Only_IA.h5')    
    model.save_weights('./LSTM model performance/Only_IA_weights.h5')  # to store
    ...
    '''
    return Feature_totally, X_train, y_train, X_val, y_val, X_test, y_test
    
      
if __name__ == '__main__':
    #Feature_totally = main()
    Feature_totally,X_train, y_train, X_val, y_val, X_test, y_test= main()
