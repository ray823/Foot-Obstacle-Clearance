...
def main():
    ...
    print(model.summary())
    with open('./LSTM model performance/Regression/modelsummary.txt', 'w') as f:
    ...
    #保存模型和權重
    saved = model.save('./LSTM model performance/Regression/Regression.h5')    
    model.save_weights('./LSTM model performance/Regression/Regression_weights.h5')  # to store
